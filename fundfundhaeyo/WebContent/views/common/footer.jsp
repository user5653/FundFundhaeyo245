...
<body>
	<div class="footer_outer font_outer" style="border-top: 1px solid lightgray">
        <%-- 전체 레이아웃 --%>
        <div class="ffh_wrap ffh_main">
			<div class="ffh_footer">
		        <div class="ffh_footer_top fl">
		            <div class="ffh_footer_top_left fl">
		                ...
		                <div class="ffh_footer_top_left5 fl">
		                    <!-- 고객센터 모달 -->
		                    <button id="btn-open-modal4" class="btn-open-modal">고객센터</button>
		                </div>
		            </div>
		        ...
		        <div class="ffh_footer_middle fl">
		            <p class="p1" style="font-size:15px">뻔뻔해요는 프로젝트의 당사자가 아니며, 직접적인 통신판매를 진행하지 않습니다. 프로젝트의 완수 및 선물제공의 책임은 해당 프로젝트의 창작자에게 있으며, 프로젝트와 관련하여 후원자와 발생하는 법적 분쟁에 대한 책임은 해당 창작자가 부담합니다.</p>
		            <p class="p2" style="font-size:15px">Copyright © 2024 FundFundhaeyo Institute All Right Reserved</p>
		        </div>
		    </div>
	    </div>
    </div>
    ...
    <div id="modal4" class="modal">
        <div class="modal_body">
            ...
            <p> </p>
            <button class="close-btn-bottom" onclick="closeModal('#modal4')">닫기</button>
        </div>
    </div>
     ...
     <script>
        ...
        const btnOpenModal4 = document.querySelector('#btn-open-modal4');
        ...
        btnOpenModal4.addEventListener("click", () => openModal('#modal4'));
    </script>
</body>
</html>